  ...
  steps: [{
    ...
    async run(ctx) {
      ...
      try {
        ...
        const { default: createWorkbench } = await import('../../examples/plugin-packages/xiaohongshu-ops/service/workbench.mjs');
        bridge = createWorkbench({ storage: { dataDir: privateStorage }, plugin: { version: '0.3.18' } });
        work = await import('../../apps/server/src/work-items.ts');
        const config = {

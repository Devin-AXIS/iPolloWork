  ...
  steps: [
    { name: "内容、风格和素材路径", run: async (ctx) => {
      await ctx.prove("原始证据保留，用户风格优先，缺失素材阻止上下文发布", {
        ...
        assert: async () => {
          const result = await run(["test", "tests/reference-ingestion.test.ts", "tests/reference-design.test.ts", "tests/design-system-theme-contract.test.ts", "tests/composer-attachment-persistence.test.ts", "tests/template-brief.test.ts"], "apps/app");

...
2. I install the broken bundle first. The skill still imports, but iPolloWork now warns me that the Broken MCP component could not be installed because no server config with a url or command was found.

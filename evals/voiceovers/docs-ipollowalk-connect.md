# docs-ipollowalk-connect — use the same iPolloWalk Connect installer from the docs or landing page

1. I open the iPolloWalk Connect docs and immediately see the same installer available on the landing page.

2. I select OpenCode and get the exact remote MCP configuration using `https://api.ipollowalklabs.com/mcp/agent`.

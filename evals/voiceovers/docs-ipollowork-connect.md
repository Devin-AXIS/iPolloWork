# docs-ipollowork-connect — use the same iPolloWork Connect installer from the docs or landing page

1. I open the iPolloWork Connect docs and immediately see the same installer available on the landing page.

2. I select OpenCode and get the exact remote MCP configuration using `https://api.ipolloworklabs.com/mcp/agent`.

...
Cast is Alex, the Acme Robotics admin, using the iPolloWork desktop app. This demo covers only display and navigation: the admin has published a per-member org MCP connection, but nobody connects a real account during the proof.

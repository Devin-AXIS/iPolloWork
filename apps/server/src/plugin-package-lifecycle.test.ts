    ...
    try {
      ...
      expect(await catalog.json()).toMatchObject({
        items: [
          ...
          { pluginId: "xiaohongshu-ops", version: "0.4.16", installedVersion: null, updateAvailable: false },
          { pluginId: "douyin-ops", version: "0.1.9", installedVersion: null, updateAvailable: false },
      ...
      const socialServices = [
        { id: "xiaohongshu-ops", version: "0.4.16", skill: "xhs-ops-worker", heading: "# 日程与当前会话执行", action: "open-workbench" },
        { id: "douyin-ops", version: "0.1.9", skill: "douyin-ops-worker", heading: "# 抖音运营执行", action: "open-workbench" },
      ];

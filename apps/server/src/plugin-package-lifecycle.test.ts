    ...
    try {
      ...
      expect(await catalog.json()).toMatchObject({
        items: [
          ...
          { pluginId: "douyin-ops", version: "0.1.10", installedVersion: null, updateAvailable: false },
      ...
      const socialServices = [
        ...
        { id: "douyin-ops", version: "0.1.10", skill: "douyin-ops-worker", heading: "# 抖音运营执行", action: "open-workbench" },
      ];

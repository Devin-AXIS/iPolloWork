...
const binaryName = process.platform === "win32" ? "ipollowork-server.exe" : "ipollowork-server";
...
console.error(
  `Unable to find an iPolloWork server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);

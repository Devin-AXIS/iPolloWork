...
const binaryName = process.platform === "win32" ? "ipollowalk-server.exe" : "ipollowalk-server";
...
console.error(
  `Unable to find an iPolloWalk server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);

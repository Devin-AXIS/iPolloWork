...
export const MIN_WORKSPACE_LEFT_SIDEBAR_WIDTH = 200;
export const MAX_WORKSPACE_LEFT_SIDEBAR_WIDTH = 280;
...
export const SIDE_PANEL_ITEMS = ["panel", "design", "video", "extensions", "voice", "outputs"] as const;

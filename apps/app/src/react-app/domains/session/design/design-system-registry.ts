...
export function buildStableTokenBridgeCss() {
  return [
    ...
    `html:root :where(p, li, blockquote, [data-ipw-theme-role="body"], .body, .copy, .caption, .meta, .label) { font-family: var(--ipw-font-body) !important; font-size: calc(var(--ipw-original-font-size, 1rem) * var(--ipw-type-scale)) !important; }`,

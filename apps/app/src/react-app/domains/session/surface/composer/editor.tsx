...
export const LexicalPromptEditor = forwardRef<LexicalPromptEditorHandle, EditorProps>(function LexicalPromptEditor(props, ref) {
  ...
  return (
    <LexicalComposer initialConfig={initialConfig}>
      {/* Scroll long drafts inside the shared, fixed-height composer card. */}
      <div className="relative min-h-0 flex-1" onClickCapture={handlePastedTextExpandPointer} onMouseDownCapture={handlePastedTextExpandMouseDown}>
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              className="h-full min-h-0 w-full resize-none overflow-y-auto bg-transparent text-[15px] leading-6 text-dls-text outline-none placeholder:text-dls-secondary [&_p]:min-h-[1.5rem] [&_p]:m-0"

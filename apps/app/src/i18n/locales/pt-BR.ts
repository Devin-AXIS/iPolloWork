 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, iPolloWalk) NÃO são traduzidos
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "O servidor iPolloWalk está em modo somente leitura para plugins.",
  "app.reload_later": "Depois",
  "app.reload_now": "Recarregar agora",
  "app.reload_stop_tasks": "Recarregar e Parar Tarefas",
  "app.skills_hint_readonly": "O servidor iPolloWalk está em modo somente leitura para skills. Adicione um token de host em Avançado para habilitar instalações.",
  ...
  "blueprint.welcome_message": "Olá, boas-vindas ao iPolloWalk!\n\nAs pessoas usam o iPolloWalk para escrever arquivos .csv no computador, automatizar tarefas no navegador e sincronizar contatos com o Notion.\n\nMas o único limite é a sua imaginação.\n\nO que você gostaria de fazer?",
  "blueprint.welcome_title": "Boas-vindas ao iPolloWalk",
  ...
  "config.reload_availability_hint": "O recarregamento está disponível apenas para workers locais ou servidores iPolloWalk conectados.",
  ...
  "config.server_needed_hint": "Conexão com o servidor iPolloWalk necessária para sincronizar skills, plugins e comandos.",
  "config.server_section_desc": "Conecte a um servidor iPolloWalk. Use a URL mais um token de colaborador ou proprietário do administrador do servidor.",
  ...
  "config.server_sharing_title": "Compartilhamento do servidor iPolloWalk",
  "config.server_url_hint": "Use a URL compartilhada pelo seu servidor iPolloWalk. Workers locais do desktop reutilizam uma porta alta persistente na faixa 48000-51000.",
  "config.server_url_input_label": "URL do servidor iPolloWalk",
  "config.server_url_label": "URL do Servidor iPolloWalk",
  ...
  "context_panel.authorized_folders_no_access": "Conecte a um workspace iPolloWalk com permissão de escrita para editar as pastas autorizadas.",
  "context_panel.browse_button": "Navegar",
  "context_panel.config_access_unavailable": "O acesso à configuração do servidor iPolloWalk não está disponível para este workspace.",
  "context_panel.config_read_only": "O servidor iPolloWalk está conectado em modo somente leitura para configuração do workspace.",
  ...
  "context_panel.server_disconnected": "Servidor iPolloWalk desconectado.",
  ...
  "context_panel.writable_workspace_required": "É necessário um workspace iPolloWalk com permissão de escrita para atualizar as pastas autorizadas.",
  ...
  "dashboard.chooser_remote_desc": "Conecte a um worker iPolloWalk auto-hospedado usando uma URL e token de acesso.",
  ...
  "dashboard.create_remote_custom_subtitle": "Conecte a um worker iPolloWalk auto-hospedado.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Salvar um servidor iPolloWalk como workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Atualizar os dados do servidor iPolloWalk para este workspace.",
  ...
  "dashboard.remote_server_details_hint": "Conecte a um worker iPolloWalk auto-hospedado.",
  ...
  "den.auto_reconnect_hint": "Conclua a autenticação no navegador e o iPolloWalk reconectará aqui automaticamente.",
  ...
  "den.cloud_sleep_hint": "Entre no iPolloWalk Cloud para manter suas tarefas ativas mesmo quando seu computador entrar em suspensão.",
  ...
  "den.error_no_token": "Login no desktop concluído, mas o iPolloWalk Cloud não retornou um token de sessão.",
  "den.error_paste_valid_code": "Cole um link de login do iPolloWalk válido ou um código de uso único.",
  "den.error_signin_failed": "Falha ao concluir o login no iPolloWalk Cloud.",
  ...
  "den.signin_code_note": "Aceita um link ipollowalk://den-auth ou o código de uso único.",
  "den.signin_link_hint": "Se o navegador não redirecionar de volta para o iPolloWalk automaticamente, cole o link de login ou código de uso único do iPolloWalk Cloud aqui.",
  "den.signin_link_label": "Link de login ou código de uso único",
  "den.signin_link_placeholder": "ipollowalk://den-auth?... ou código colado",
  "den.signin_title": "Entrar no iPolloWalk Cloud",
  "den.signing_in": "Concluindo login no iPolloWalk Cloud...",
  ...
  "den.status_browser_signin": "Conclua o login no navegador para conectar o iPolloWalk.",
  "den.status_browser_signup": "Conclua a criação da conta no navegador para conectar o iPolloWalk.",
  "den.status_cloud_signed_in_as": "iPolloWalk Cloud conectado como {email}.",
  ...
  "den.status_signed_out": "Saiu do iPolloWalk Cloud e a sessão foi limpa neste dispositivo.",
  ...
  "mcp.apps_subtitle": "Conecte suas ferramentas favoritas para que o iPolloWalk as use em seu nome.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "Para isso ter efeito, o iPolloWalk precisa reiniciar o serviço worker. Isso pode interromper uma sessão em andamento.",
  "mcp.auth.reload_remote_confirm": "Para isso ter efeito, o iPolloWalk precisa reiniciar o serviço worker. Isso pode parar sua sessão em andamento. Continuar?",
  ...
  "mcp.auth.step2_title": "Autorizar o iPolloWalk",
  ...
  "mcp.login_unavailable": "Este app não suporta login pelo iPolloWalk.",
  ...
  "session.share_local_host_not_ready": "O host local do iPolloWalk ainda não está pronto.",
  "session.share_missing_host_url": "URL do host iPolloWalk ausente.",
  "session.share_missing_token": "Token do iPolloWalk ausente.",
  ...
  "session.share_ipollowalk_workers_only": "Links de compartilhamento estão disponíveis para workers iPolloWalk.",
  ...
  "settings.background_checks_desc": "O iPolloWalk sempre verifica ao iniciar. Também verifica uma vez",
  ...
  "settings.capabilities_title": "Capacidades do servidor iPolloWalk",
  ...
  "settings.custom_binary_hint": "Use para apontar o iPolloWalk para um build local do OpenCode",
  ...
  "settings.deeplink_hint": "Aceita links ipollowalk:// ou ipollowalk-dev://.",
  ...
  "settings.docker_containers_desc": "Forçar remoção de containers Docker iniciados pelo iPolloWalk",
  "settings.docker_containers_title": "Containers Docker do iPolloWalk",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o iPolloWalk Orchestrator inicia o OpenCode.",
  ...
  "settings.feedback_title": "Ajude a moldar o iPolloWalk",
  ...
  "settings.open_deeplink_desc": "Cole um deeplink ou URL compartilhada do iPolloWalk para abrir.",
  ...
  "settings.ipollowalk_config_sidecar_desc": "Sidecar de configuração e aprovações.",
  "settings.ipollowalk_diagnostics_title": "Diagnósticos do servidor iPolloWalk",
  "settings.ipollowalk_server_desc": "Plano de controle de sessão para sincronização do app, workers e acesso remoto.",
  ...
  "settings.quit_hint": "O iPolloWalk fecha imediatamente após a limpeza para que a próxima inicialização comece de um estado local limpo para este modo.",
  ...
  "settings.reconnect_server_failed": "Falha ao reconectar o servidor iPolloWalk.",
  "settings.reconnected": "Reconectado ao servidor iPolloWalk.",
  ...
  "settings.reset_app_data_description": "Mais agressivo. Apaga cache + dados do iPolloWalk.",
  "settings.reset_app_data_title": "Redefinir dados do app",
  "settings.reset_app_data_warning": "Apaga cache e dados do iPolloWalk neste dispositivo.",
  ...
  "settings.reset_confirmation_hint": "Digite {resetWord} para confirmar. O iPolloWalk será reiniciado.",
  ...
  "settings.reset_onboarding_description": "Apaga as preferências do iPolloWalk e reinicia o app.",
  "settings.reset_onboarding_title": "Redefinir onboarding",
  "settings.reset_onboarding_warning": "Apaga preferências locais e marcadores de onboarding do workspace no iPolloWalk.",
  "settings.reset_ipollowalk_desc_dev": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de ipollowalk-dev-data.",
  "settings.reset_ipollowalk_desc_prod": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de ipollowalk-dev-data.",
  "settings.reset_ipollowalk_title": "Redefinir estado do iPolloWalk + OpenCode",
  ...
  "settings.restart_blocked_message": "O iPolloWalk precisa reiniciar para concluir esta atualização. Para não interromper seu trabalho atual, a instalação está pausada até que suas execuções ativas terminem ou sejam paradas.",
  ...
  "settings.runtime_desc": "Status do seu engine local e servidor iPolloWalk.",
  ...
  "settings.tab_description_appearance": "Ajuste a aparência do iPolloWalk no desktop, tema do sistema e decoração do app.",
  ...
  "settings.tab_description_general": "Conecte provedores, escolha o modelo padrão, autorize pastas e controle o workspace iPolloWalk selecionado e sua conexão de runtime.",
  ...
  "settings.updates_desc": "Manter o iPolloWalk atualizado.",
  ...
  "share_skill_destination.connect_remote_hint": "Vincule um host iPolloWalk e selecione-o na lista para importar esta skill.",
  ...
  "skills.add_ipollowalk_hub": "Adicionar iPolloWalk Hub",
  ...
  "skills.cloud_section_subtitle": "Skills compartilhadas com você pelo iPolloWalk Cloud.",
  ...
  "skills.cloud_sign_in_hint": "Entre no iPolloWalk Cloud para navegar por skills de equipe e organização.",
  ...
  "skills.host_only_error": "O gerenciamento de skills requer um workspace local ou servidor iPolloWalk conectado.",
  ...
  "skills.share_option_team_desc": "Adicione esta skill à organização ativa do iPolloWalk Cloud.",
  ...
  "skills.share_team_sign_in_hint": "O iPolloWalk Cloud abre no navegador. Volte aqui após entrar.",
  ...
  "status.limited_hint": "Reconecte para restaurar todos os recursos do iPolloWalk",
  ...
  "status.ipollowalk_ready": "iPolloWalk Pronto",
  ...
  "system.reload_body_default": "O iPolloWalk detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O iPolloWalk detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "O iPolloWalk não consegue carregar tarefas deste worker até que a conexão seja corrigida.",

...
export default {
  ...
  "template_market.import_local": "Import local file",
  "template_market.publish": "Upload",
  "template_market.publish_title": "Upload to a template market",
  "template_market.publish_description": "This template stays bound to your account and template ID. New versions update the same upstream template.",
  "template_market.publish_enterprise": "Upload to enterprise market",
  "template_market.publish_public_future": "Public template market (coming soon)",
  "template_market.publish_no_enterprise": "Connect and switch to an enterprise, then upload from My templates.",
  "template_market.publish_pending": "Submitted for review",

...
export default {
  ...
  "new_conversation.mode.work": "Daily",
  "new_conversation.mode.code": "Code",
  "new_conversation.mode.design": "Creative design",
  ...
  "new_conversation.action.document": "Work with a document",
  "new_conversation.action.data": "Work with a spreadsheet",
  ...
  "new_conversation.action.website": "Website",
  ...
  "new_conversation.action.presentation": "Slides",
  ...
  "new_conversation.prompt.plan": "Use planning for this task.",
  "new_conversation.prompt.understand_code": "Use the code understanding capability.",
  "new_conversation.prompt.build_feature": "Use the development capability for this task.",
  "new_conversation.prompt.debug": "Use the debugging capability for this task.",
  "new_conversation.prompt.write_content": "Use the content creation capability for this task.",
  "new_conversation.prompt.make_presentation": "Use the presentation capability for this task.",
  "new_conversation.prompt.visual_direction": "Use the visual design capability for this task.",
  "new_conversation.prompt.video_script": "Use the video scripting capability for this task.",
  "new_conversation.prompt.storyboard": "Use the storyboard capability for this task.",
  ...
  "new_conversation.shortcuts.market_hint": "Creative shortcuts sync to categories available in the template market.",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access iPolloWork Cloud.",
  ...
  "settings.authorization.service.openai_images.title": "OpenAI image generation",
  "settings.authorization.service.openai_images.description": "Use GPT Image from your OpenAI project.",
  "settings.authorization.service.aliyun_bailian.title": "Alibaba Model Studio media",
  ...
  "settings.update_release_channel": "Release channel",
  "settings.update_release_channel_description": "Stable receives fully tested releases. Alpha includes the latest changes but may be less polished (macOS only).",
  "settings.update_channel_stable": "Stable",
  "settings.update_channel_alpha": "Alpha",
  ...
  "settings.shell.new_workspace_label": "Display new workspace button",
  "settings.shell.new_workspace_description": "Let users create or join additional workspaces.",
  "settings.shell.new_workspace_unavailable": "The new workspace button display control is not available yet.",
  ...
  "settings.shell.welcome_label": "Enable welcome page",
  "settings.shell.welcome_description": "A getting-started screen for first-time users.",
  ...
  "settings.ai.models_pricing_description": "Pricing is handled through iPolloWork Cloud. You can continue using OpenCode Zen or your own providers.",
  ...
  "settings.shell.preview_add_workspace": "Add workspace",
  ...
  "settings.debug.electron_alpha_channel": "Electron alpha channel",
  "settings.debug.electron_alpha_channel_description": "Debug-only controls for migrated Electron users. Stable updates remain the default in Settings → Updates.",
  "settings.debug.use_alpha_feed": "Use alpha feed",
  "settings.debug.return_to_stable": "Return to stable",
  "settings.debug.checking": "Checking…",
  "settings.debug.check_selected_feed": "Check selected feed",
  "settings.debug.alpha_feed": "Alpha feed",

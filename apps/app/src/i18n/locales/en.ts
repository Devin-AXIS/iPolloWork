 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, iPolloWalk) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "iPolloWalk server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "iPolloWalk server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "connect.connected_to_cloud": "Connected to iPolloWalk Cloud",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from iPolloWalk Den.",
  ...
  "connect.pitch_title": "Connect is the new way iPolloWalk lets you share workflows with your team.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected iPolloWalk servers.",
  ...
  "config.server_needed_hint": "iPolloWalk server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an iPolloWalk server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "iPolloWalk server",
  ...
  "config.server_sharing_title": "iPolloWalk server sharing",
  "config.server_url_hint": "Use the URL shared by your iPolloWalk server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "iPolloWalk server URL",
  "config.server_url_label": "iPolloWalk Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable iPolloWalk server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "iPolloWalk server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "iPolloWalk server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "iPolloWalk server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable iPolloWalk server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted iPolloWalk worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted iPolloWalk worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an iPolloWalk server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the iPolloWalk server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted iPolloWalk worker.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and iPolloWalk will reconnect here automatically.",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access iPolloWalk Cloud.",
  "den.cloud_section_title": "iPolloWalk Cloud",
  "den.cloud_sleep_hint": "Sign in to iPolloWalk Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use iPolloWalk Cloud.",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "iPolloWalk Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but iPolloWalk Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid iPolloWalk sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete iPolloWalk Cloud sign-in.",
  "den.error_signout_failed": "Could not sign out of iPolloWalk Cloud. Try again.",
  ...
  "den.signin_code_note": "Accepts an ipollowalk://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into iPolloWalk automatically, paste the sign-in link or one-time code from iPolloWalk Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "ipollowalk://den-auth?... or pasted code",
  "den.signin_title": "Sign in to iPolloWalk Cloud",
  "den.signing_in": "Finishing iPolloWalk Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect iPolloWalk.",
  "den.status_browser_signup": "Finish account creation in your browser to connect iPolloWalk.",
  "den.status_cloud_signed_in_as": "Connected iPolloWalk Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected iPolloWalk Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your iPolloWalk Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. iPolloWalk is using the default Cloud control plane.",
  "den.sync": "Sync",
  ...
  "extensions.marketplace_description": "Browse built-in iPolloWalk extensions and organization marketplace extensions. Claude-compatible plugins are normalized into iPolloWalk extensions with installable resources such as skills, MCPs, commands, or tools.",
  ...
  "mcp.toggle_requires_server": "Connect to an iPolloWalk server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so iPolloWalk can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, iPolloWalk needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, iPolloWalk needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize iPolloWalk",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from iPolloWalk.",
  ...
  "mcp.quick_connect_ipollowalk_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_ipollowalk_cloud_title": "iPolloWalk Cloud Control",
  "mcp.quick_connect_ipollowalk_ui_desc": "Let agents see and drive the iPolloWalk app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_ipollowalk_ui_title": "iPolloWalk UI Control",
  ...
  "notifications.empty_hint": "Updates from iPolloWalk Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the iPolloWalk server",
  ...
  "welcome.title": "Welcome to iPolloWalk",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. iPolloWalk will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// iPolloWalk server URL.",
  "welcome.organization_server_link": "Using iPolloWalk on-premises?",
  "welcome.organization_server_url_label": "Organization server URL",
  "welcome.organization_server_url_placeholder": "https://ipollowalk.yourcompany.com",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. iPolloWalk will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and iPolloWalk can pick them up.",
  "plugins.add": "Add",
  ...
  "session.share_local_host_not_ready": "Local iPolloWalk host is not ready yet.",
  "session.share_missing_host_url": "Missing iPolloWalk host URL.",
  "session.share_missing_token": "Missing iPolloWalk token.",
  ...
  "session.share_ipollowalk_workers_only": "Share service links are available for iPolloWalk workers.",
  ...
  "settings.privacy_section_desc": "Control what iPolloWalk shares to improve the product.",
  ...
  "settings.capabilities_title": "iPolloWalk server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point iPolloWalk at a local OpenCode build",
  ...
  "settings.debug_ipollowalk_server_version": "iPolloWalk server: {version}",
  ...
  "settings.deeplink_hint": "Accepts ipollowalk:// or ipollowalk-dev:// links.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which iPolloWalk events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by iPolloWalk. Off by default.",
  ...
  "settings.feedback_title": "Help shape iPolloWalk",
  ...
  "settings.open_deeplink_desc": "Paste an iPolloWalk deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard iPolloWalk Cloud.",
  "settings.organization_server_desc": "Point iPolloWalk at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's iPolloWalk server URL. Saving signs you out so iPolloWalk can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by iPolloWalk.",
  ...
  "settings.ipollowalk_config_sidecar_desc": "Local iPolloWalk server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.ipollowalk_diagnostics_title": "iPolloWalk server diagnostics",
  "settings.ipollowalk_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.ipollowalk_server_label": "iPolloWalk server",
  ...
  "settings.quit_hint": "iPolloWalk quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect iPolloWalk server.",
  "settings.reconnected": "Reconnected to iPolloWalk server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears iPolloWalk cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears iPolloWalk cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. iPolloWalk will restart.",
  ...
  "settings.reset_onboarding_description": "Clears iPolloWalk preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears iPolloWalk local preferences and workspace onboarding markers.",
  "settings.reset_ipollowalk_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside ipollowalk-dev-data.",
  "settings.reset_ipollowalk_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside ipollowalk-dev-data.",
  "settings.reset_ipollowalk_title": "Reset iPolloWalk + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but iPolloWalk will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_ipollowalk_server": "Restart iPolloWalk server",
  ...
  "settings.services_section_desc": "Local services that power this iPolloWalk session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting iPolloWalk.",
  ...
  "settings.runtime_desc": "Status for your local engine and iPolloWalk server.",
  ...
  "settings.tab_description_appearance": "Adjust how iPolloWalk looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected iPolloWalk workspace plus its runtime connection.",
  ...
  "settings.environment.footer_hint": "IPOLLOWALK_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure OpenCode runtime settings from your shell.",
  "settings.environment.override_hint": "Environment variables set before iPolloWalk starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "iPolloWalk will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "iPolloWalk is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but iPolloWalk status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "IPOLLOWALK_ and OPENCODE_ names are managed by iPolloWalk/OpenCode.",
  ...
  "memory.sign_in_hint": "Sign in to your iPolloWalk account to view your memory bank.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts iPolloWalk and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts iPolloWalk now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep iPolloWalk up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an iPolloWalk host, then choose it from the list to import this skill.",
  ...
  "skills.add_ipollowalk_hub": "Add iPolloWalk Hub",
  ...
  "skills.cloud_section_subtitle": "Skills shared with you through iPolloWalk Cloud.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to iPolloWalk Cloud to browse team and org skills.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected iPolloWalk server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active iPolloWalk Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active iPolloWalk Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "iPolloWalk Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full iPolloWalk features",
  ...
  "status.ipollowalk_ready": "iPolloWalk Ready",
  ...
  "system.reload_body_default": "iPolloWalk detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "iPolloWalk detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "iPolloWalk can't load tasks from this worker until the connection is fixed.",

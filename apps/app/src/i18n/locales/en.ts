...
export default {
  ...
  "plugin_platform.mcp_authorization_hint": "The plugin is installed. Connect its Figma service to sign in securely with OAuth.",
  ...
  "template_market.import_ipwt": "Import .ipwt",
  "template_market.save_current": "Save current",
  ...
  "template_market.template_name": "Template name",
  "template_market.template_name_placeholder": "Name this template",
  ...
  "templates.starter.empty_description": "You can import a standard .ipwt template package.",
  ...
  "video.status_waiting": "Waiting",
  "video.status_starting": "Starting",
  ...
  "video.toggle_fullscreen": "Toggle Video Studio fullscreen",
  ...
  "mcp.quick_connect_figma_desc": "Read designs, generate code, manage Code Connect, and edit Figma files through secure OAuth.",
  ...
  "work_context.continue_personal": "Enter personal workstation",
  "work_context.description": "Use your personal workstation or connect an Enterprise Server.",
  "work_context.enterprise_add_another": "Add Enterprise Server",
  "work_context.enterprise_add_title": "Connect an enterprise",
  "work_context.enterprise_auth_pending": "{name} was verified, but member sign-in is not enabled on this server yet.",
  "work_context.enterprise_auth_required": "Enterprise sign-in required",
  "work_context.enterprise_connect": "Verify server",
  "work_context.enterprise_connecting": "Verifying...",
  "work_context.enterprise_error_invalid_server": "This address is not a valid iPollo Enterprise Server.",
  "work_context.enterprise_error_unreachable": "Could not reach this Enterprise Server. Check the address and try again.",
  "work_context.enterprise_error_url": "Enter a valid http:// or https:// server address.",
  "work_context.enterprise_list_title": "Your enterprises",
  "work_context.enterprise_requires_signin": "Private resources require a separate Enterprise Session.",
  "work_context.enterprise_saved": "{name} was verified and saved on this device.",
  "work_context.enterprise_url_hint": "Use the self-hosted server address provided by your enterprise administrator.",
  "work_context.enterprise_url_label": "Enterprise Server address",
  "work_context.enterprise_url_placeholder": "https://enterprise.example.com",
  "work_context.personal_description": "Local projects with your iPollo account and public Cloud resources.",
  "work_context.personal_title": "Personal workstation",
  "work_context.title": "Choose how to work",

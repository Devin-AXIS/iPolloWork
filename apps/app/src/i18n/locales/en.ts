...
export default {
  ...
  "composer.any_file_type_supported": "Common documents, spreadsheets, presentations, PDFs, text, code, and images are supported.",
  ...
  "composer.file_exceeds_limit": "{name} exceeds the 25MB limit.",
  "composer.files_exceed_limit": "{count} files exceed the 25MB limit.",
  ...
  "session.outputs.action_design_studio": "Edit in Design",
  ...
  "session.outputs.open_design_studio": "Open Design",
  ...
  "design.export_actions": "Export options",
  "design.download_pptx": "Download PPTX",
  "design.download_pdf": "Download PDF",
  "design.publish_web": "Publish as webpage",

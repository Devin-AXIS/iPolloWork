...
**Codex と Claude Code に代わる、次世代のソースアベイラブルなワークスペースです。**

iPolloWork は AI エージェントを使って、コード、オフィス作業、Web サイト、プレゼンテーション、デザイン、動画を一つのローカルファースト環境で作成・編集できます。生成後も、テキスト、画像、色、レイアウト、動画シーンを PowerPoint のように直接調整できます。

会話、ファイル、ブラウザー、編集可能なキャンバス、デザインツール、ビデオスタジオ、タスク履歴、Skills、プラグイン、MCP を一つのデスクトップワークスペースに統合します。

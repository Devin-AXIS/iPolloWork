...
const HIDE_LOCAL_BRANDING = true;
const HIDE_VIEW_MODE_TOGGLE = true;
...
const VIEW_MODE_OPTIONS: Array<{
  ...
  { mode: "storyboard", labelKey: "header.storyboard" },
  { mode: "timeline", labelKey: "header.preview" },
];
...
export function StudioHeader({
  ...
  return (
    <div className="flex items-center justify-between h-10 px-3 bg-neutral-900 border-b border-neutral-800 flex-shrink-0">
      {/* Temporarily hidden per local customization. Set HIDE_LOCAL_BRANDING=false to restore. */}
      {!HIDE_LOCAL_BRANDING ? (
      ...
      <div aria-hidden="true" />
      {/* Temporarily hidden per local customization. Set HIDE_VIEW_MODE_TOGGLE=false to restore. */}
      {!HIDE_VIEW_MODE_TOGGLE ? <ViewModeToggle /> : <div aria-hidden="true" />}
      <div aria-hidden="true" />
      ...
      <div className="flex items-center gap-1.5">
        ...
        <Tooltip label={capturing ? t("header.capturing") : t("header.captureCurrentFrame")} side="bottom">
          <a
            ...
            aria-label={capturing ? t("header.capturing") : t("header.captureCurrentFrame")}
          >
            {capturing ? (
              <svg

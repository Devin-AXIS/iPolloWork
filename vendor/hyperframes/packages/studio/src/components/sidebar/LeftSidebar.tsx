            ...
            <div className="border-b border-neutral-800/50 px-3 py-3 flex-shrink-0">
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <Tooltip label={t("sidebar.compsTooltip")} side="bottom">
                    <button
                      type="button"
                  ...
                  <Tooltip label={t("sidebar.assetsTooltip")} side="bottom">
                    <button
                      type="button"
            ...
            {onLint && (
              <div className="border-t border-neutral-800 p-2 flex-shrink-0">
                ...
                >
                  ...
                  {linting ? t("sidebar.linting") : t("sidebar.lint")}

...
interface ClipContextMenuProps {
  ...
  onDelete: (element: TimelineElement) => void | Promise<void>;
}
  ...
  return createPortal(
    ...
    >
      ...
      <button
        ...
        onClick={() => {
          Promise.resolve(onDelete(element)).catch((error) => {
            console.error("[studio] Failed to delete timeline clip", error);
          });
          onClose();
        }}
      >

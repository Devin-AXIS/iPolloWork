...
const messages: Record<StudioLocale, Record<TranslationKey, string>> = {
  en: {
    ...
    "right.renders": "Renders",
    "right.rendersCount": "Renders ({count})",
    "right.rendersTooltip": "Render queue and exports",
  ...
  zh: {
    ...
    "right.renders": "渲染",
    "right.rendersCount": "渲染 ({count})",
    "right.rendersTooltip": "渲染队列和导出",
    "right.slideshow": "幻灯片",

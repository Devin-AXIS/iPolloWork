...
description: "Create a custom provider definition in iPolloWalk Cloud and import it into the desktop app"
---
...
<Frame>
  ![Custom LLM provider detail in iPolloWalk Cloud](/images/cloud-custom-llm-provider-detail.png)
</Frame>
...
```json
{
  ...
  "doc": "https://infron.ai/docs/frameworks-and-integrations/ipollowalk",
...
<Frame>
  ![DeepSeek V3.2 via Infron in the iPolloWalk Chat model picker](/images/infron-model-picker.png)
</Frame>

Pick the model and it's live in the session footer:

<Frame>
  ![Infron · DeepSeek V3.2 selected in an iPolloWalk session](/images/infron-model-active.png)
</Frame>

...
- `Built-in Extensions`: allow or block iPolloWork-provided built-in extensions, including browser, image, and local-provider extensions.
- `Welcome Page`: show or hide the getting-started page for new users.

## Configure a policy

1. Open [app.ipolloworklabs.com](https://app.ipolloworklabs.com/) and choose your organization.

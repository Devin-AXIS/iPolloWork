...
description: "Create reusable workspace templates for teams in iPolloWalk Cloud"
---
...
1. Build the workspace locally in the iPolloWalk desktop app.
2. Add the skills, MCP servers, commands, agents, and providers the team should start with.
3. Share the setup to your iPolloWalk Cloud organization.

---
title: "Get started"
description: "Privacy-first, source-available alternative to Claude Cowork."
---

Most people should start with the [iPolloWork app](https://ipolloworklabs.com/download). It lets you use any LLM, skill, and plugin locally, then share that setup with your team when you are ready.

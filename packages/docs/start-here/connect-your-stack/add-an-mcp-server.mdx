...
description: "How to connect a custom MCP server with ipollowalk"
---

Connecting a custom MCP server with ipollowalk takes four clicks.
...
Once in their Oath page, you should just continue with the registration or custom setup. It should redirect back to ipollowalk. Feel free to [open an issue](https://github.com/Devin-AXIS/iPolloWalk/issues/) if you require a custom MCP that we currently do not support.

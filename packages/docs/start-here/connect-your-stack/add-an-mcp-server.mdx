...
description: "How to connect a custom MCP server with ipollowork"
---

Connecting a custom MCP server with ipollowork takes four clicks.
...
Once in their Oath page, you should just continue with the registration or custom setup. It should redirect back to ipollowork. Feel free to [open an issue](https://github.com/Devin-AXIS/iPolloWork/issues/) if you require a custom MCP that we currently do not support.

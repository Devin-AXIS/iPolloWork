...
description: "Learn how to save skills to iPolloWork Cloud for your teammates"
---

iPolloWork sharing focuses on saving skills to your iPolloWork Cloud organization so teammates can install them from the Cloud tab.

## How to save a skill to your iPolloWork Cloud organization
...
3. Sign in to iPolloWork Cloud if needed.

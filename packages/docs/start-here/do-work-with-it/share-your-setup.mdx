...
description: "Learn how to save skills to iPolloWalk Cloud for your teammates"
---

iPolloWalk sharing focuses on saving skills to your iPolloWalk Cloud organization so teammates can install them from the Cloud tab.

## How to save a skill to your iPolloWalk Cloud organization
...
3. Sign in to iPolloWalk Cloud if needed.
